					...
					<div class="banner-left" style="float:left;width:518px;padding:14px;margin-right: 58px;">
						<div>
							...
							<div class="lanyardtext">
								<p>This has the highest quality of material we use for lanyards. Woven material implies

							durability and will make your lanyards really last for quite a long time. How we do it is

							we will stitch, like embroidering, your personalized message and logo giving it an

							embedded like texture when you touch it. If you choose this lanyard style, it is best

							recommended to use just simple type of logos since complex logos might end up a little

							visually pixilated.</p>
							</div>
					</div>
