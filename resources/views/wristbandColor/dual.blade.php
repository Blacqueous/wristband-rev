...
<div id="wrist_color_container_dual" class="wrist-color-container">
    ...
    <!-- content -->
    <div class="content">
        <div id="tab_dual_reg" class="tab-pane js-color" data-value="0.01" data-color="Dual">
            <h3>Dual Colors</h3>
            ...
            <div id="main-color-content" class="main-color-content">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 box-color-container">
                    <div class="col-xs-12 box-color">
                        ...
                        <div class="col-xs-12 box-color-title">
                            <button id="custom-color-button" class="btn-order" data-toggle="modal" data-target="#modalColorDual">Custom Color</button>
                        </div>
                        ...
                        <span class="view-more col-xs-12" data-toggle="collapse" data-target="#view_more_dual-CUSTOM0">View More Sizes</span>
                        <div id="view_more_dual-CUSTOM0" class="col-xs-12 show-content collapse">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 box-color-container">
                    <div class="col-xs-12 box-color">
                        ...
                        <span class="view-more col-xs-12" data-toggle="collapse" data-target="#view_more_dual_reg-@foreach($value['hex'] as $key => $val)@if($key!=0)-@endif{{ $val }}@endforeach">View More Sizes</span>
                        <div id="view_more_dual_reg-@foreach($value['hex'] as $key => $val)@if($key!=0)-@endif{{ $val }}@endforeach" class="col-xs-12 show-content collapse">
                            <div class="col-xs-6 box-color-qty">
                                <label>Extra Small</label>
