...
<div id="wrist_color_container_figured_large" class="wrist-color-container">
    ...
    <ul class="nav nav-pills js-color">
        <li class="active">
            <a data-toggle="pill" href="#tab_solid_fig_lg">Solid</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_segmented_fig_lg">Segmented</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_swirl_fig_lg">Swirls</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_glow_fig_lg">Glow</a>
        </li>
    </ul>
    <!-- End: nav -->
