...
<div id="wrist_color_container_regular_thin" class="wrist-color-container">
    ...
    <ul class="nav nav-pills js-color">
        <li class="active">
            <a data-toggle="pill" href="#tab_solid_reg_tn">Solid</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_segmented_reg_tn">Segmented</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_swirl_reg_tn">Swirls</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_glow_reg_tn">Glow</a>
        </li>
    </ul>
    <!-- End: nav -->
