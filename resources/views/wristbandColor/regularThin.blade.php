...
<div id="wrist_color_container_regular_thin" class="wrist-color-container">

    @if(isset($colors['reg_tn']))
    <!-- nav -->
    <ul class="nav nav-pills js-color">
        <li class="active">
            <a class="wb-nav-pill" data-toggle="pill" href="#tab_solid_reg_tn">Solid</a>
        </li>
        <li>
            <a class="wb-nav-pill" data-toggle="pill" href="#tab_segmented_reg_tn">Segmented</a>
        </li>
        <li>
            <a class="wb-nav-pill" data-toggle="pill" href="#tab_swirl_reg_tn">Swirls</a>
        </li>
        <li>
            <a class="wb-nav-pill" data-toggle="pill" href="#tab_glow_reg_tn">Glow</a>
        </li>
    </ul>
    <!-- End: nav -->
    ...
    <div class="tab-content">
        <!-- #solid tab -->
        <div id="tab_solid_reg_tn" class="tab-pane fade in active js-color" data-color-style="solid">
            <h3>Solid Colors</h3>
        ...
        <!-- #segmented tab -->
        <div id="tab_segmented_reg_tn" class="tab-pane fade js-color" data-color-style="segmented">
        ...
        <!-- #swirl tab -->
        <div id="tab_swirl_reg_tn" class="tab-pane fade js-color" data-color-style="swirl">
            <h3>Swirl Colors</h3>
        ...
        <!-- #glow tab -->
        <div id="tab_glow_reg_tn" class="tab-pane fade js-color" data-color-style="glow">
            <h3>Glow</h3>

            @if(isset($colors['reg_tn']['glow']))
            <div id="main-color-content" class="main-color-content">
