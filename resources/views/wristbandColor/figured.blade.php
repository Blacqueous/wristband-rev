...
<div id="wrist_color_container_figured" class="wrist-color-container">
    ...
    <ul class="nav nav-pills js-color">
        <li class="active">
            <a data-toggle="pill" href="#tab_solid_fig">Solid</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_segmented_fig">Segmented</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_swirl_fig">Swirls</a>
        </li>
        <li>
            <a data-toggle="pill" href="#tab_glow_fig">Glow</a>
        </li>
    </ul>
    <!-- End: nav -->
