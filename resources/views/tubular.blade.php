	...
	<div class="container">
				...
				<div class="section-lanyards">
					<div class="banner-left" style="float:left;width:518px;padding:14px;margin-right: 58px;">
						<div>
							 <h2>Tubular Lanyard</h2>
								<div class="slideshow-container">
									<div class="mySlides fade">
									  <img src="{{ URL::asset('assets/lanyard/images/tubular.jpg')}}" style="width:100%">
									</div>

									<div class="mySlides fade">
									  <img src="{{ URL::asset('assets/lanyard/images/tubular-1.png')}}" style="width:100%">
									</div>

									<div class="mySlides fade">
									  <img src="{{ URL::asset('assets/lanyard/images/tubular-3.png')}}" style="width:100%">
									</div>
								</div>
							...
							<div class="lanyardtext">
								<p>This is our most economical style of lanyards. It is made of polyester that are loosely

								stitched and formed into a tube that strengthens its durability. It is somewhat similar to

								a tubular lace of your favorite sneakers. We use high quality screen printing of your

								personalize message and logo to ensure highest standard of your customize lanyards.</p>
							</div>
					</div>
