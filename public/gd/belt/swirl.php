<?php
	...
	function generate_swirl($colors)
	{
		...
		if (!file_exists("img/preview/regular/swirl/" . $name . ".png")) {
			...
			if (!file_exists('img/preview/regular/swirl')) {
				mkdir('img/preview/regular/swirl', 0777, true); // If not, then create directory path
			}
			// Make image
			imagepng( $img_0_dst, "img/preview/regular/swirl/" . $name . ".png" );
