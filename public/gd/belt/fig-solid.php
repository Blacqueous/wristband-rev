<?php
	...
	function generate_fig_solid($colors)
	{
		...
		if (!file_exists("img/preview/figured/solid/" . $name . ".png")) {
			...
			if (!file_exists('img/preview/figured/solid')) {
				mkdir('img/preview/figured/solid', 0777, true); // If not, then create directory path
			}
			// Make image
			imagepng( $img_0_dst, "img/preview/figured/solid/" . $name . ".png" );
		...
		echo( "/gd/img/preview/figured/solid/" . $name . ".png" );
